...
def intervention_loop_console(
    ...
    for index, row in parcel_df.iterrows():
        ...
        if row["gsa_hol_id"] not in checked_holdings and dm.disable_holding_loop == False:
            ...
            print("Checking parcel group (prepare)")
            parcel_group = parcel_df[parcel_df["gsa_par_id"] == row["gsa_par_id"]]
            print("Checking parcel group (check)")
        ...
        print("Checking new full buckets")
